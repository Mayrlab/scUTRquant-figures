---
title: "Table 1 - Compare CellRanger vs scUTRquant Clustering - No Multimapping"
...
df_counts <- readRDS("data/sce/processed/df_counts.no_multimapping.pca.Rds")
```
...
```{r export_tbl}
write_xlsx(df_clusters, "output/tables/tbl1-mm10-multimapping-clustering-ari.xlsx")
```
