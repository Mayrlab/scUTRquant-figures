---
title: "Compare CellRanger vs scUTRquant Clustering - PBMC"
...
Both CellRanger and scUTRquant are based on a CellRanger-filtered version of Ensembl 
Release 93 for GRCh38. 
...
### Export
```{r export_basic} 
saveRDS(df_counts, "data/sce/processed/df_counts_pbmc_cr.all_genes.pca.Rds")
```
...
### Export
```{r export_common} 
saveRDS(df_counts, "data/sce/processed/df_counts_pbmc_cr.common_genes.pca.Rds")
```
