...
### Export
```{r export_basic} 
saveRDS(df_counts, "data/sce/processed/df_counts_pbmc_utrome.all_genes.pca.Rds")
```
...
### Export
```{r export_common} 
saveRDS(df_counts, "data/sce/processed/df_counts_pbmc_utrome.common_genes.pca.Rds")
```
