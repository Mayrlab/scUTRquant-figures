...
TSV_WD_TEST="data/dtu/20230522-hsc-ery-twosample-wd.min50.boot10k.tsv.gz"
TSV_WUI_TEST="data/dtu/20230522-hsc-ery-twosample-wui.min50.boot10k.tsv.gz"
TSV_LUI_TEST="data/dtu/20230522-hsc-ery-twosample-lui.min50.boot10k.tsv.gz"
TSV_IPA_TEST="data/dtu/20230522-hsc-ery-twosample-ipa.min50.boot10k.tsv.gz"
```
...
df_test_ery_hsc_wui %>%
  mutate(sig=qval < MAX_QVAL,
         abs_dwui=ifelse(abs(stat) < MIN_DWUI, "< 0.15", ">=0.15")) %$%
  table(sig, abs_dwui)
```

### Volcano Plot
```{r plot_volcano_wui, fig.width=7, fig.height=5}
wuiVolcanoPlot(df_test_ery_hsc_wui, max_q=0.05, min_dwui=0.15)
```

```{r plot_volcano_wui_save, fig.width=5, fig.height=5}
wuiVolcanoPlot(df_test_ery_hsc_wui, max_q=0.05, min_dwui=0.15, legend=FALSE)
