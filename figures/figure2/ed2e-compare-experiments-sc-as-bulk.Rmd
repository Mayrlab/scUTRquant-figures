---
title: "Compare Transcript TPMs - Experiments (Single-Cell as Bulk)"
...
Here the Bleckwehl and Guo are quantified as though they were bulk 3'-seq data.
...
ggsave("output/figure2/ed2f-mescs-all-tpm-noumi.pdf", width=6, height=6, dpi=300)
```
...
ggsave("output/figure2/fig2g-mescs-bulk-bulk-tpm-noumi.pdf", width=5, height=4)
```
...
ggsave("output/figure2/fig2h-mescs-bulk-sc-tpm-noumi.pdf", width=5, height=4)
```
...
ggsave("output/figure2/fig2i-mescs-sc-sc-tpm-noumi.pdf", width=5, height=4)
```
