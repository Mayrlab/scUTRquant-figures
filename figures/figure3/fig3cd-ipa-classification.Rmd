...
ggsave("output/figure3/ed3b-n-ipa-isoforms-pct05.pdf", width=4, height=4, dpi=300)
```
...
ggsave("output/figure3/fig3b-n-ipa-isoforms-pct10.pdf", width=4, height=4, dpi=300)
```
...
ggsave("output/figure3/fig3d-ncelltypes-gene-ipa-pct10.filled-bars.pdf", width=4, height=4, dpi=300)
```
