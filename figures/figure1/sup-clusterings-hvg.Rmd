...
### Export
```{r export_basic} 
saveRDS(df_counts, sprintf("data/sce/processed/df_counts.all_genes.hvg%d.pca.Rds", N_HVGS))
```
...
### Export
```{r export_common} 
saveRDS(df_counts, sprintf("data/sce/processed/df_counts.common_genes.hvg%d.pca.Rds", N_HVGS))
```
