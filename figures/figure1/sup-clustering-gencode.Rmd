---
title: "Compare CellRanger vs scUTRquant Clustering - GENCODE"
...
### Export
```{r export_basic} 
saveRDS(df_counts, "data/sce/processed/df_counts_gencode.all_genes.pca.Rds")
```
...
### Export
```{r export_common} 
saveRDS(df_counts, "data/sce/processed/df_counts_gencode.common_genes.pca.Rds")
```
